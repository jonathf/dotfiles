...
def set_mappings(c, config):
    ...
    c.aliases = {
        ...
        'tabs': 'config-cycle tabs.show always never',
    ...
    config.bind('gt', 'spawn --userscript dispatch gt cmd-set-text -s :buffer')
    ...
    config.bind('P', 'forward')
    config.bind('zi', 'zoom-in')
    config.bind('zo', 'zoom-out')
    config.bind('z0', 'zoom')
    # config.bind('o', 'cmd-set-text -s :open')
    config.bind('o', 'spawn --userscript dispatch o cmd-set-text -s :open')
    config.bind('O', 'cmd-set-text -s :open {url:pretty}')
    config.bind('r', 'spawn --userscript dispatch r reload')
    config.bind('t', 'cmd-set-text -s :open --tab')
    config.bind('T', 'cmd-set-text -s :open --tab {url:pretty}')
