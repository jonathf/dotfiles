function awslogin --description 'log into aws with'
  ...
  set CODEARTIFACT_AUTH_TOKEN (aws codeartifact get-authorization-token --domain datascience --domain-owner 621389033208 --region eu-west-1 --query authorizationToken --output text)
  set PIP_INDEX_URL https://aws:$CODEARTIFACT_AUTH_TOKEN@datascience-621389033208.d.codeartifact.eu-west-1.amazonaws.com/pypi/machine-learning/simple/
